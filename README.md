...
Modern AI tooling makes it dangerously easy to ship code you couldn't write yourself. That's a great way to get features out the door and a terrible way to grow as an engineer. After noticing that reliance starting to atrophy real skills — particularly Python fluency, algorithmic thinking, and system-design judgment — I set up this repo to do the opposite of vibe-coding: study with intention, write code by hand, get challenged on what I think I know, and track honestly when I don't.

The goal is to operate at a strong mid-to-senior level across the full stack with credible AI-engineering depth, with the kind of vocabulary and judgment that holds up in design rounds and on real production work — not just in autocomplete.
...
- **Git as backup.** Weekly commits to main. No branching strategy needed — the repo is single-author and the work is the artifact.
...
That distinction — using AI to accelerate *learning* rather than to replace *thinking* — is the whole reason this repo exists.
